...
<head>
    ...
    <title>Bloom Ease | Services</title>
...
<body class="bg-white">
    ...
    <section class="min-h-screen bg-[url('/images/image14.png')] bg-cover bg-center">
        <header class="bg-[#120F1133] md:flex md:flex-row justify-between items-center lg:px-10 md:px-3 py-10 hidden">
            ...
            <div class="md:space-x-3 lg:space-x-16 justify-center text-white md:text-lg lg:text-xl">
                ...
                <a href="/services" class="underline decoration-[#0768B3] decoration-2">Services</a>
        ...
        <div class="flex flex-col text-center items-center justify-center text-white px-8 lg:mt-16 mt-20 pb-5">
            ...
            <a href="/contact" class="bg-gradient-to-r from-[#0768B3] to-[#032D4D] lg:px-14 px-10 py-3 rounded-3xl text-white md:text-base lg:text-lg font-semibold mt-10">Get in Touch</a>
        </div>
    </section>

    <section class="flex flex-col bg-[url('/images/image15.png')] bg-cover bg-center"> 
        <div class="flex flex-col md:flex-row justify-between items-center w-full lg:p-20 pb-5 p-5">
            <div class="flex flex-col text-white items-start justify-center w-full lg:w-1/2 lg:mt-0 mt-10 lg:mb-0 mb-10">
    ...
    <section class="flex bg-white">
        <div class="flex flex-col md:flex-row justify-between items-center w-full lg:p-20 p-5">
            <div class="w-full lg:w-1/2 flex justify-center items-center">
                <img src="/images/Group 10.png" alt="" class="">
            </div>
    ...
    <section class="flex flex-col bg-black">
        <div class="flex flex-col md:flex-row justify-between items-center w-full lg:p-20 pb-5 p-5">
            <div class="flex flex-col text-white items-start justify-center w-full lg:w-1/2 lg:mt-0 mt-10 lg:mb-0 mb-10">
                <p class="lg:text-4xl text-3xl font-semibold md:text-start text-center">
                    WEBSITE MANAGEMENT

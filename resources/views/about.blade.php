...
<head>
    ...
    <title>Bloom Ease | About Us</title>
...
<body class="bg-white">
    <section class="bg-[url('/images/image14.png')] bg-cover bg-center">
        <header class="bg-[#120F1133] md:flex md:flex-row justify-between items-center lg:px-10 md:px-3 py-10 hidden">
            ...
            <div class="md:space-x-3 lg:space-x-16 justify-center text-white md:text-lg lg:text-xl">
                <a href="/about" class="underline decoration-[#0768B3] decoration-2">About</a>
        ...
        <div class="flex flex-col text-center items-center justify-center text-white px-8 lg:mt-16 mt-20 pb-10 lg:pb-20">
    ...
    <section class="flex h-full bg-[url('/images/image15.png')] bg-cover bg-center">
        <div class="flex flex-col md:flex-row justify-between items-center w-full lg:p-10 lg:pt-8 p-5">
            <div class="flex flex-col text-white justify-center w-full lg:w-1/2 lg:mt-0 mt-10 lg:mb-0 mb-10">
                <p class="text-3xl font-semibold md:text-start text-center">
                    WHAT IS BLOOM EASE TECHNOLOGY?
                </p>
    ...
    <section class="bg-white w-full flex flex-col">
        <div class="flex flex-col p-10 justify-center items-center">
            <p class="text-center lg:text-4xl text-3xl font-semibold mb-10">OUR WORK PROGRESS</p>
                
            <div class="flex md:flex-row flex-col w-full md:space-y-0 space-y-7 md:space-x-10">
                <div class="flex flex-col border border-[#000000] px-7 py-5 rounded-xl">
                <p class="text-xl mb-1 font-semibold">
                    <span class="text-5xl bg-clip-text text-transparent bg-gradient-to-r from-[#0768B3] to-[#032D4D]">1.</span> 
                    <br/>
                    <span class="bg-clip-text text-transparent bg-gradient-to-r from-[#0768B3] to-[#032D4D]">LOREM ISPUM HEADER</span>
                </p>
            <p class="text-lg">
                Lorem ispum body text. Lorem ispum body text. 
                Lorem ispum body text. Lorem ispum body text. 
                Lorem ispum body text. Lorem ispum body text. 
                Lorem ispum body text. Lorem ispum body text. 
                Lorem ispum body text.
                ...
                <div class="flex flex-col border border-[#000000] px-7 py-5 rounded-xl">
                    <p class="text-xl mb-1 font-semibold">
                        <span class="text-5xl bg-clip-text text-transparent bg-gradient-to-r from-[#0768B3] to-[#032D4D]">2.</span> 
                        <br/>
                        <span class="bg-clip-text text-transparent bg-gradient-to-r from-[#0768B3] to-[#032D4D]">LOREM ISPUM HEADER</span>
                    </p>
                    <p class="text-lg">Lorem ispum body text. Lorem ispum body text. 
                        Lorem ispum body text. Lorem ispum body text. 
                        Lorem ispum body text. Lorem ispum body text. 
                        Lorem ispum body text. Lorem ispum body text. 
                        Lorem ispum body text.
                ...
                <div class="flex flex-col border border-[#000000] px-7 py-5 rounded-xl">
                    <p class="text-xl mb-1 font-semibold">
                        <span class="text-5xl bg-clip-text text-transparent bg-gradient-to-r from-[#0768B3] to-[#032D4D]">3.</span> 
                        <br/>
                        <span class="bg-clip-text text-transparent bg-gradient-to-r from-[#0768B3] to-[#032D4D]">LOREM ISPUM HEADER</span>
                    </p>
                    <p class="text-lg">Lorem ispum body text. Lorem ispum body text. 
            ...
            <div class="flex md:flex-row flex-col w-full md:space-y-0 space-y-7 md:space-x-10 mt-4">
                <div class="flex flex-col border border-[#000000] px-7 py-5 rounded-xl">
                    <p class="text-xl mb-1 font-semibold">
                        <span class="text-5xl bg-clip-text text-transparent bg-gradient-to-r from-[#0768B3] to-[#032D4D]">4.</span> 
                        <br/>
                        <span class="bg-clip-text text-transparent bg-gradient-to-r from-[#0768B3] to-[#032D4D]">LOREM ISPUM HEADER</span>
                    </p>
                    <p class="text-lg">Lorem ispum body text. Lorem ispum body text. 
                ...
                <div class="flex flex-col border border-[#000000] px-7 py-5 rounded-xl">
                    <p class="text-xl mb-1 font-semibold">
                        <span class="text-5xl bg-clip-text text-transparent bg-gradient-to-r from-[#0768B3] to-[#032D4D]">5.</span> 
                        <br/>
                        <span class="bg-clip-text text-transparent bg-gradient-to-r from-[#0768B3] to-[#032D4D]">LOREM ISPUM HEADER</span>
                    </p>
                    <p class="text-lg">Lorem ispum body text. Lorem ispum body text. 
                ...
                <div class="flex flex-col border border-[#000000] px-7 py-5 rounded-xl">
                    <p class="text-xl mb-1 font-semibold">
                        <span class="text-5xl bg-clip-text text-transparent bg-gradient-to-r from-[#0768B3] to-[#032D4D]">6.</span> 
                        <br/>
                        <span class="bg-clip-text text-transparent bg-gradient-to-r from-[#0768B3] to-[#032D4D]">LOREM ISPUM HEADER</span>
                    </p>
                    <p class="text-lg">Lorem ispum body text. Lorem ispum body text. 
    ...
    <section class="flex bg-[url('/images/image15.png')] bg-cover bg-center">
        <div class="flex flex-col md:flex-row justify-between items-center w-full lg:p-10 p-5">
            <div class="w-full lg:w-1/2 flex justify-center items-center relative">
                <img src="/images/group14.png" alt="" class="absolute">
                <img src="/images/Ellipse1.png" alt="" class="relative">
            </div>

            <div class="flex flex-col text-white justify-center w-full lg:w-1/2 lg:mt-0 mt-10 lg:mb-0 mb-10">
                <p class="lg:text-4xl text-3xl font-semibold md:text-start text-center">
                    WHAT IS BLOOM EASE TECHNOLOGY?
                </p>
                <p class="lg:text-2xl text-xl mt-6 font-semibold">
                    Lorem ispum body text. Lorem ispu m body text. 
                    Lorem ispum body text. Lorem ispum body text. Lorem ispum body text. 
                    Lorem ispum body text. Lorem ispum body text. Lorem ispum body text. 
                    Lorem ispum body text. Lorem ispum body text. Lorem ispum body text. 
                    Lorem ispum body text. Lorem ispum body text. Lorem ispum body text. 
                    Lorem ispum body text.
